...
## Table 1
```{r table 1, fig.height = 4, fig.width= 6.5, fig.align= "center"}
data <- read.dta13("Ideology_Trump.dta")
#summary(data)
#view(data)
#Table 1 - Regression Results
...
```
<br>
![Figure 2, Barber and Pope](/Users/carinehajjar/Desktop/fig2.png)
...
```
<br>
![Figure 4, Barber and Pope](/Users/carinehajjar/Desktop/fig4.png)
...
```
<br>
![Figure 5, Barber and Pope](/Users/carinehajjar/Desktop/fig5.png)
...
# Proposed Extension
In the extension, I will be addressing a plotting issue in Figure 1, expanding the test of partisanship to Democrats as well as Republicans, and choosing one of the figures to experiment with a different regression model. 
